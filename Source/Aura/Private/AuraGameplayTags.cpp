...
void FAuraGameplayTags::InitializeNativeGameplayTags()
{
	...
	*/
	...
	GameplayTags.Attributes_Primary_Resilience = UGameplayTagsManager::Get().AddNativeGameplayTag(FName("Attributes.Primary.Resilience"), FString("Increases Armor and ArmorPenetration."));
	GameplayTags.Attributes_Primary_Vigor = UGameplayTagsManager::Get().AddNativeGameplayTag(FName("Attributes.Primary.Vigor"), FString("Increases Health."));
	
	/*
	* Secondary Attributes
	*/
	GameplayTags.Attributes_Secondary_Armor = UGameplayTagsManager::Get().AddNativeGameplayTag(FName("Attributes.Secondary.Armor"), FString("Reduces taken Damage, improves Block Chance."));
	...
	*/
	...
	GameplayTags.InputTag_Interact = UGameplayTagsManager::Get().AddNativeGameplayTag(FName("InputTag.Interact"), FString("Input Tag for E Key."));
	
	
	GameplayTags.InputTag_Alt = UGameplayTagsManager::Get().AddNativeGameplayTag(FName("InputTag.Alt"), FString("Input Tag for Alt Key."));
	...
	GameplayTags.InputTag_Passive_3 = UGameplayTagsManager::Get().AddNativeGameplayTag(FName("InputTag.Passive.3"), FString("Input Tag for Passive Ability 3."));
	GameplayTags.InputTag_Passive_4 = UGameplayTagsManager::Get().AddNativeGameplayTag(FName("InputTag.Passive.4"), FString("Input Tag for Passive Ability 4."));
	...
	*/
	...
	GameplayTags.Damage_Passive = UGameplayTagsManager::Get().AddNativeGameplayTag(FName("Damage.Passive"), FString("Passive Damage Type."));
	...
	*/
	...
	GameplayTags.Attributes_Resistance_Arcane = UGameplayTagsManager::Get().AddNativeGameplayTag(FName("Attributes.Resistance.Arcane"), FString("Resistance to Arcan Damage."));
	...
	*/
	...
	GameplayTags.Debuff_Physical = UGameplayTagsManager::Get().AddNativeGameplayTag(FName("Debuff.Physical"), FString("Debuff to Physical Damage."));
	...
	* Meta Attributes
	*/
	GameplayTags.Attributes_Meta_IncommingXP = UGameplayTagsManager::Get().AddNativeGameplayTag(FName("Attributes.Meta.IncommingXP"), FString("IncommingXP Meta Attribute."));
	...
	*/
	...
	GameplayTags.Abilities_Dash = UGameplayTagsManager::Get().AddNativeGameplayTag(FName("Abilities.Dash"), FString("Dash Ability Tag."));
	...
	*/
	...
	GameplayTags.Abilities_Type_Dash = UGameplayTagsManager::Get().AddNativeGameplayTag(FName("Abilities.Type.Dash"), FString("Type Dash."));
	...
	*/
	...
	GameplayTags.Player_Block_InputReleased = UGameplayTagsManager::Get().AddNativeGameplayTag(FName("Player.Block.InputReleased"), FString("Block Input Held Released for input."));
