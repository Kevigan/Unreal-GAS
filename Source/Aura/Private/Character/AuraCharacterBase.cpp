...
AAuraCharacterBase::AAuraCharacterBase()
{
	...
	BurnDebuffComp = CreateDefaultSubobject<UDebuffNiagaraComponent>("BurnDebuffComponent");
	BurnDebuffComp->SetupAttachment(GetRootComponent());
	BurnDebuffComp->DebuffTag = FAuraGameplayTags::Get().Debuff_Burn;

	StunDebuffComp = CreateDefaultSubobject<UDebuffNiagaraComponent>("StunDebuffComponent");
	StunDebuffComp->SetupAttachment(GetRootComponent());
	StunDebuffComp->DebuffTag = FAuraGameplayTags::Get().Debuff_Stun;
